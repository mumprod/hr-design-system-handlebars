...
import teaser33EventSerif from './fixtures/teaser_standard_33_serif_single_event.json'
...
<Preview withToolbar>
    <Story name="Standard 33 single event" args={teaser33EventSerif.logicItem.includeModel}>
        {Template.bind({})}
    </Story>
