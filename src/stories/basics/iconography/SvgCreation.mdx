...
<div style={{display: 'block', marginLeft: '50px'}}>
Die Ecken des großen Rechtecks asymmetrisch abrunden und kleine Quadrate in ein trapezoide Form überführen. Generell gilt:
mit möglichst einfachen Transformationen, die ursprünglichen Objekte verändern, um wenige Pfadpunkte zu erzeugen.
</div>
</p>
...
<div style={{display: 'block', marginLeft: '50px'}}>
Das Icon ist fertig erstellt. Alle Primitiven, liegen als editierbare Objekte vor und können jederzeit in Form oder Gestalt geändert werden.
</div>
</p>
