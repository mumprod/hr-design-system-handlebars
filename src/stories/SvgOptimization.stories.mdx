...
<Meta title="Dokumentation/Grundlegendes/Icons" />
...
Zur Optimierung der Icons und der Erzeugung von SVG-Maps ist in der Datei `package.json` ein Skript `optimze-svgs` konfiguriert. Es kann durch Aufruf von `npm run optimize-svgs`
ausgeführt werden. Das Skript, welches mit Hilfe des Taskrunners [Gulp](https://gulpjs.com/) geschrieben wurde, führt automatisiert hintereinander verschiedene Aufgaben aus.
