...
import teaser66SingleEventSerif from './fixtures/teaser_standard_66_serif_single_event.json'
...
<Preview withToolbar>
    ...
    <Story name="Standard 33 multiple events" args={teaser33MultipleEventsSerif.logicItem.includeModel}>
        {Template.bind({})}
    </Story>
    <Story name="Standard 50 single event" args={teaser50SingleEventSerif.logicItem.includeModel}>
        {Template.bind({})}
    </Story>
    <Story name="Standard 66 single event" args={teaser66SingleEventSerif.logicItem.includeModel}>
        {Template.bind({})}
    </Story>
