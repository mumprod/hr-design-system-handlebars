...
<Canvas>
    <Story name="Default" args={JsonData} parameters={{}}>
        {Template.bind({})}
    </Story>
</Canvas>
...
<ul>
    <li>
        components/site_header/<b>anchor_navigation</b>
    </li>
    <li>
        components/site_header/<b>brand_navigation</b>
    </li>
    <li>
        components/site_header/<b>service_navigation</b>
    </li>
    <li>
        components/site_header/<b>section_navigation</b>
    </li>
</ul>
<br />
