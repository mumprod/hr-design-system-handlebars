...
-   **tailwind.css** — Dies ist die Haupt CSS Datei des Designsystems. In ihr werden alle Utlityklassen des tailwind.css Frameworks eingebunden,
    benutzerdefinierte CSS Klassen geschrieben sowie CSS-Custom Properties fürs Theming der einzelnen Marken definiert.
